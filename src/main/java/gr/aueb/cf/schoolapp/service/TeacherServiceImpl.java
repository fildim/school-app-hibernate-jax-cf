...
public class TeacherServiceImpl implements ITeacherService{
    ...
    public Teacher updateTeacher(TeacherUpdateDTO dto) throws EntityNotFoundException {
        ...
        try {
            ...
            if (teacherDAO.getById(teacherToUpdate.getId()) == null) throw new EntityNotFoundException(Teacher.class, teacherToUpdate.getId());
    ...
    public void deleteTeacher(Long id) throws EntityNotFoundException {
        try {
            ...
            if (teacherDAO.getById(id) == null) throw new EntityNotFoundException(Teacher.class, id);
            ...
            JPAHelper.rollbackTransaction();
            logger.warn("Delete teacher rollback - Error");
            throw e;
        } finally {
            JPAHelper.closeEntityManager();
        }
    ...
    public List<Teacher> getTeachersByLastname(String lastname) throws EntityNotFoundException {
        ...
        try {
            ...
            if (teachers.size() == 0) throw new EntityNotFoundException(List.class, 0L);

            JPAHelper.commitTransaction();
        } catch (EntityNotFoundException e) {
            JPAHelper.rollbackTransaction();
            logger.warn("Teachers not found by lastname - rollback");
            throw e;
        } finally {
            JPAHelper.closeEntityManager();
        }
